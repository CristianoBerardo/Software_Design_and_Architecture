...
\begin{flushleft}
  ...
  \begin{minipage}{0.27\linewidth}
    \centering
    \includegraphics[width=0.7\linewidth]{images/Architecture-visualization/AV-esempio1.png}
...
\paragraph{Examples:} Application (server-side or client side), Database, file system, etc., Microservice (if not a system per se), Mobile app, Script (python, shell, R, etc.)
...
The basic building blocks of a programming language: classes, interfaces, functions, objects, enums
...
It helps answering such questions: What is the software system that we are building (or have built)?, Who is using it?, How does it fit in with the existing environment?


It is \textbf{required}: it is the starting point for communicating with any stakeholder
The key elements of a context diagram are: \textbf{People} who will use the software system, Other \textbf{software} systems with which the reference system interacts, + optionally the \textbf{organization boundary}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.7\linewidth]{content/chapters/images/2026-03-22-12-05-11.png}
  \end{minipage}
\end{flushleft}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.7\linewidth]{content/chapters/images/2026-03-22-12-08-20.png}
  \end{minipage}
\end{flushleft}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\linewidth]{content/chapters/images/2026-03-22-12-07-46.png}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\linewidth]{content/chapters/images/2026-03-22-12-24-41.png}
\end{figure}
...
\begin{center}
  \begin{minipage}{0.5\linewidth}
    \begin{minipage}{0.47\linewidth}
      \centering
      \includegraphics[width=0.7\linewidth]{content/chapters/images/2026-03-22-12-25-47.png}
    \end{minipage}%
    \hfill
    \begin{minipage}{0.47\linewidth}
      \centering
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.3\linewidth]{content/chapters/images/2026-03-22-12-26-49.png}
\end{figure}

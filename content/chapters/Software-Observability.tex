...
\begin{itemize}
  \item Structured: consistent schema or typed fields, can be JSON or other

  \item Unstructured: don't follow a consistent structure, therefore much more diﬀicult to parse
        and analyze at scale

  \item Semistructured: include machine-readable key/value pairs or delimited fields but do not
...
\begin{center}
  ...
  \begin{minipage}{0.47\linewidth}
    \centering
    \includegraphics[width=0.5\linewidth]{content/chapters/images/2026-05-10-09-11-00.png}
  \end{minipage}
\end{center}
...
\begin{flushleft}
  ...
  \begin{minipage}[h!]{0.4\linewidth}
    \paragraph{Model}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-05-10-10-55-29.png}
  \end{minipage}
\end{flushleft}

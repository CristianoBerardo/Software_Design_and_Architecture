...
\begin{itemize}
  ...
  \item \textbf{Unstructured}: don't follow a consistent structure, therefore much more diﬀicult to parse
...
\begin{flushleft}
  ...
  \begin{minipage}[t]{0.4\linewidth}
    \vspace{0pt}
    \includegraphics[width=0.6\linewidth]{content/chapters/images/2026-05-10-10-55-29.png}
    \captionof{figure}{Model}
  \end{minipage}
\end{flushleft}

...
\begin{table}[h!]
  ...
  \centering
  \begin{tabularx}{\textwidth}{>{\raggedleft\arraybackslash}X >{\raggedleft\arraybackslash}X >{\raggedleft\arraybackslash}X}
    \toprule
...
If $G$ is a strongly connected graph:
\[
  V(G) = \#E - \#N + 1
\]
...
\begin{center}
  \begin{minipage}{0.42\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-05-26-21-36-23.png}
  \end{minipage}%
  \hfill

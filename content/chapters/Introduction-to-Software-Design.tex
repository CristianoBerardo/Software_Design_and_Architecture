...
\begin{itemize}
  ...
  \item \textbf{overexposure}: API forces knowledge about rarely used features to use common ones. E.g. \mintinline{java}{BufferedReader r = new BufferedReader(new InputStreamReader(System.in));}
...
\subsection{Deﬁne Errors out of Existence}

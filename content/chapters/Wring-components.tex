...
\textbf{"Don't call us, we'll call you}"
...
\end{minted}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.4\linewidth]{content/chapters/images/2026-03-27-10-28-11.png}
...
\end{minted}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.4\linewidth]{content/chapters/images/2026-03-27-10-31-01.png}
    \captionof{figure}{Call diagram}
  \end{minipage}
\end{center}
...
\textbf{Template method} - \textbf{Strategy pattern} - \textbf{Observer pattern}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-03-27-11-04-05.png}
  \end{minipage}
\end{center}
...
\end{minted}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-03-27-11-13-04.png}
  \end{minipage}
\end{flushleft}
...
\end{minted}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-03-27-11-17-52.png}
  \end{minipage}
\end{flushleft}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-03-27-11-34-23.png}
  \end{minipage}
\end{center}


In this case sender does NOT know:  Who consumes the message, When the message is processed, How many consumers exist
...
Producer and consumer are independent processes, they can run on diﬀerent machines and the broker is infrastructure.

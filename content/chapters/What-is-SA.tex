...
\begin{center}
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.35\linewidth}
      \centering
      \includegraphics[width=0.8\linewidth]{images/SA/SA-esempio1.png}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{center}
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.35\linewidth}
      \centering
      \includegraphics[width=0.7\linewidth]{images/SA/SA-esempio2.png}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{center}
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.25\linewidth}
      \centering
      \includegraphics[width=0.45\linewidth]{images/SA/SA-esempio5.png}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{center}
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.25\linewidth}
      \centering
      \includegraphics[width=0.85\linewidth]{images/SA/SA-esempio4.png}
    \end{minipage}
  \end{minipage}
\end{center}

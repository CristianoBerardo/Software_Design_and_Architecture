...
\begin{center}
  \begin{minipage}{0.6\linewidth}
    \begin{minipage}{0.47\linewidth}
      \centering
      \includegraphics[width=\linewidth]{content/chapters/images/2026-04-11-11-42-08.png}
    \end{minipage}%
    \hfill
    \begin{minipage}{0.47\linewidth}
      \centering
      \includegraphics[width=\linewidth]{content/chapters/images/2026-04-11-12-18-32.png}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.7\linewidth]{content/chapters/images/2026-04-11-12-21-52.png}
  \end{minipage}
\end{flushleft}
...
\begin{center}
  \begin{minipage}[t]{0.49\linewidth}
    \vspace{0pt}
    \subsubsection{Domain model Example}
    \centering
    \includegraphics[width=0.6\linewidth]{content/chapters/images/2026-04-11-12-26-07.png}
  \end{minipage}%
  \hfill%
  \begin{minipage}[t]{0.49\linewidth}
    \vspace{0pt}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.8\linewidth]{content/chapters/images/2026-04-11-12-34-15.png}
  \end{minipage}
\end{flushleft}
...
\subsubsection{Decomposition obstacles}: Network latency, Reduced availability due to synchronous communication, Data consistency across services, Obtaining a consistent view of the data, Good classes
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-04-11-12-45-11.png}
  \end{minipage}
\end{flushleft}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-04-11-12-46-25.png}
    \captionof{figure}{Ports \& Adapters (hex)}
  \end{minipage}
\end{flushleft}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-04-11-12-56-55.png}
  \end{minipage}
\end{center}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-04-11-12-58-44.png}
  \end{minipage}
\end{flushleft}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-04-11-13-22-15.png}
  \end{minipage}
\end{flushleft}
...
instances change continuously due to: Autoscaling, Failures, Updates.
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.7\linewidth]{content/chapters/images/2026-04-11-13-35-30.png}
  \end{minipage}
\end{flushleft}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.7\linewidth]{content/chapters/images/2026-04-11-13-35-54.png}
  \end{minipage}
\end{flushleft}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.25\linewidth}
    ...
    \includegraphics[width=0.7\linewidth]{content/chapters/images/2026-04-11-13-47-31.png}
  \end{minipage}
\end{flushleft}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.3\linewidth]{content/chapters/images/2026-04-11-13-38-57.png}
\end{figure}
...
\begin{flushleft}
  \begin{minipage}[t]{0.49\linewidth}
    ...
    Failures of client, server, or broker might represent a problem.
    Message are guaranteed to be delivered at least once, but not only once.
...
Lack of isolation leads to: \textbf{Lost updates}, \textbf{Dirty reads}, \textbf{Nonrepeatable reads}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.7\linewidth]{content/chapters/images/2026-04-11-14-01-58.png}
  \end{minipage}
\end{flushleft}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.5\linewidth]{content/chapters/images/2026-04-11-14-03-09.png}
  \end{minipage}
\end{flushleft}

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.3\linewidth]{content/chapters/images/2026-04-11-16-39-52.png}
\end{figure}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.8\linewidth]{content/chapters/images/2026-04-11-14-06-47.png}
  \end{minipage}
\end{flushleft}
...
\begin{center}
  \begin{minipage}{0.6\linewidth}
    \begin{minipage}[t]{0.45\linewidth}
      \centering
      \includegraphics[width=0.8\linewidth]{content/chapters/images/2026-04-11-16-46-51.png}
      \captionof{figure}{New features as services}
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{0.45\linewidth}
      \centering
      \includegraphics[width=0.8\linewidth]{content/chapters/images/2026-04-11-16-47-38.png}

...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.7\linewidth]{content/chapters/images/2026-04-25-11-40-35.png}
...
\begin{center}
  \begin{minipage}{0.65\linewidth}
    ...
    Common patterns are: \textbf{Presentation} layer, \textbf{Business} logic layer, \textbf{Persistence} layer, \textbf{Database} layer
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-04-25-11-49-01.png}
    \captionof{figure}{Layered architecture - variations}
  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.6\linewidth]{content/chapters/images/2026-04-25-12-02-42.png}
  \end{minipage}
\end{center}
...
\begin{flushleft}
  \begin{minipage}{0.65\linewidth}
    ...
    \begin{itemize}
      ...
      \item Modular: com.app.customer.profile; com.app.customer.profile.presentation;
    \end{itemize}
  \end{minipage}%
  \hfill
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-04-25-12-06-52.png}
    \captionof{figure}{Variations of modular monolithic style}
  \end{minipage}
\end{flushleft}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.55\linewidth]{content/chapters/images/2026-04-25-12-51-42.png}
  \end{minipage}
\end{center}

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.45\linewidth]{content/chapters/images/2026-04-25-12-55-06.png}
  \caption{UI: variants}
\end{figure}

...
\begin{center}
  ...
  \begin{minipage}{0.35\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/Components/C-esempio7.png}
  \end{minipage}
\end{center}
...
\begin{itemize}
  \item The \textbf{Acyclic Dependencies Principle} (ADP): The dependency graph of packages must have no cycles.
  \item The \textbf{Stable Dependencies Principle} (SDP): Depend in the direction of stability.
  \item The \textbf{Stable Abstractions Principle} (SAP): Abstractness increases with stability.
\end{itemize}
...
Entities -> Database and Interactor -> Presenters, View, Controllers, Authorizer -> Main
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    ...
    \includegraphics[width=\linewidth]{images/Components/C-esempio9.png}
  \end{minipage}
\end{flushleft}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.7\linewidth]{images/Components/C-esempio5.png}
  \end{minipage}
\end{flushleft}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.6\linewidth]{content/chapters/images/2026-03-22-10-38-08.png}
    \captionof{figure}{Technical partitioning vs domain partitioning}
  \end{minipage}
\end{center}

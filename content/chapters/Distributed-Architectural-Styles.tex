...
Four primary components: Initiating event, Event broker, Event processor, Derived events
...
\begin{center}
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.33\linewidth}
      \centering
      \includegraphics[width=\linewidth]{content/chapters/images/2026-05-21-10-23-04.png}
      \captionof{figure}{EDA processing - example with SPG}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/chapters/images/2026-05-21-10-35-27.png}
  \end{minipage}
\end{flushleft}
...
Two common implementations: Correlation \textbf{ID}, Temporary \textbf{queue} with specific id
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.8\linewidth]{content/chapters/images/2026-05-21-10-38-58.png}
  \end{minipage}
\end{center}
...
\begin{flushleft}
  \begin{minipage}[t]{0.49\linewidth}
    ...
    = \textbf{Asynchronous} replication vs \textbf{synchronous} replication
    Replicated caching:

    \begin{itemize}
      \item requires in-memory data grid, very fast
      \item difficult with very high data volumes and frequent updates
      \item possible also with near-cache techniques: a caching server + partial front caches
    \end{itemize}
  \end{minipage}%
  \hfill%
  \begin{minipage}[t]{0.49\linewidth}
...
\subsection{SBA architecture - When to use}

High volume applications - Large, concurrent user load - Low-latency systems

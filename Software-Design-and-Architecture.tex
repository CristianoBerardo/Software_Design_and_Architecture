...
\DocumentMetadata{} % required for transparent package v0.5+ with pdflatex

% toptesti document class
\documentclass[%
    % 10pt, % base font size
    % corpo=10pt, % dimension of basic font (legacy toptesi option)
    % Modificato Cristiano Berardo
    9pt, % base font size
    corpo=9pt, % dimension of basic font (legacy toptesi option)
...
\input{content/chapters/Introduction-to-Software-Design.tex}
\input{content/chapters/Design-patterns.tex}
\input{content/chapters/What-is-SA.tex}
\input{content/chapters/Design-Principles.tex}
\input{content/chapters/Component-principles.tex}
\input{content/chapters/Architecture-visualization.tex}
\input{content/chapters/Wring-components.tex}
\input{content/chapters/Communication.tex}
\input{content/chapters/Microservices.tex}
\input{content/chapters/Bending-Spoons.tex}
\input{content/chapters/Boundary.tex}
\input{content/chapters/Momolithic-AS.tex}
\input{content/chapters/Software-Quality.tex}
\input{content/chapters/Software-Observability.tex}
\input{content/chapters/Distributed-Architectural-Styles.tex}
\input{content/chapters/Deployment.tex}
\input{content/chapters/Software-measurement.tex}

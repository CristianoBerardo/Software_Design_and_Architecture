...
% \usepackage[top=30mm, bottom=30mm, inner=25mm, outer=25mm]{geometry} % inner larger for binding (cucitura)
% modificato da Cristiano Berardo
\usepackage[top=20mm, bottom=20mm, inner=17mm, outer=17mm]{geometry} % inner larger for binding (cucitura)
...
% Pacchettti importati da Cristiano Berardo

% boh ho cambiato il compilatore e ora il font è più piccolo 2021->2017
\usepackage{minted} %paccetto più moderno rispetto a listings
\usemintedstyle{xcode}
\usepackage{csquotes} % must be loaded after fvextra/minted
